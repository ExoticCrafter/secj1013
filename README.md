...
### 🧠 Course Overview  
**Programming Technique I (SECJ1013)** introduces the fundamentals of structured programming using the **C++ programming language**.  
This repository serves as a personal archive for assignments, lab exercises, and mini projects throughout the course.  
